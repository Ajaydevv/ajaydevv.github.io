            ...
            {stories.map((story) => {
              ...
              return (
                ...
                >
                    ...
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      {isOwner && !isEditing && (
                        <button
                          ...
                          className="sm:opacity-0 sm:group-hover:opacity-100 flex items-center gap-1 sm:gap-1.5 px-2 sm:px-2.5 py-1.5 rounded-lg text-xs text-muted-foreground hover:text-primary hover:bg-primary/10 transition-all duration-200"
                        >
                  ...
                  {!isEditing && <div className="px-3 sm:px-6 py-2.5 sm:py-3 border-t border-border/40 flex items-center gap-0.5 sm:gap-1">
                    <button
                    ...
                    <div className="ml-auto">
                      <Link
                        to={`/story/${story.id}`}
                        className="flex items-center gap-1 px-2.5 sm:px-3 py-1.5 rounded-lg text-xs text-muted-foreground hover:text-primary hover:bg-primary/5 transition-all duration-200"
                      >
                  ...
                  {/* Comments panel */}
                  {isExpanded && (
                    <div className="border-t border-border/40 bg-black/20 px-3 sm:px-6 py-4 sm:py-5 space-y-4">
                      {user && (
                      ...
                      <div className="space-y-3">
                        ...
                        {comments[story.id]?.map((comment) => (
                          ...
                          >
                            ...
                            <div className="flex-1 min-w-0 bg-card/40 rounded-xl px-3 sm:px-4 py-3 border border-border/30">
                              <div className="flex flex-wrap items-baseline justify-between gap-x-2 gap-y-0.5 mb-1">
                                ...
                                <span className="text-xs text-muted-foreground/60">{formatDate(comment.created_at)}</span>
                              </div>
